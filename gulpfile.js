...
// let dateOfProject = new Date();
// let yearOfProject = dateOfProject.getFullYear();
// let monthOfProject = (+dateOfProject.getMonth() + 1).toString();
// if (+monthOfProject < 10) monthOfProject = '0' + monthOfProject;
// let dayOfProject = dateOfProject.getDate();
// if (+dayOfProject < 10) dayOfProject = '0' + dayOfProject;
// let dateStr = '_' + yearOfProject + '.' + monthOfProject + '.' + dayOfProject;
